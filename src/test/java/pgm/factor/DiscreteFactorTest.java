...
public class DiscreteFactorTest {
    ...
    public void testGetAssignment() {
        DiscreteFactor factor = new DiscreteFactor.Builder()
                .variables(1, 2, 3)
                .card(2, 3, 2)
                .values(0.2, 0.8, 0.1, 0.9, 0.4, 0.6, 0.3, 0.7, 0.9, 0.1, 0.2, 0.8)
                .build();
    ...
    public void testProductTwoFactors1() {
        ...
        DiscreteFactor c = new DiscreteFactor.Builder()
                .variables(1, 2)
                .card(2, 2)
                .values(0.0649, 0.1958, 0.0451, 0.6942)
                .build();
    ...
    public void testProductTwoFactors2() {
        ...
        DiscreteFactor z = new DiscreteFactor.Builder()
                .variables(1, 2, 3)
                .card(3, 2, 2)
                .values(0.25, 0.05, 0.15, 0.08, 0, 0.09, 0.35, 0.07, 0.21, 0.16, 0, 0.18)
                .build();
    ...
    public void productThreeFactors() {
        ...
        DiscreteFactor result = new DiscreteFactor.Builder()
                ...
                .card(2, 3, 2, 2, 3, 2, 2)
                .values(0.06250, 0.01250, 0.03750, 0.10000, 0.00000, 0.11250, 0.01250, 0.00250, 0.00750, 0.02000,
