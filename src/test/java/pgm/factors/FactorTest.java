...
public class FactorTest {
    ...
    public void testConstruction() {
        ...
        Factor factor = Assignments.of(Arrays.asList(0.5d, 0.5d), a).stream().collect(FactorCollectors.toFactor());
    ...
    public void testGetAssignment() {
        ...
        Factor factor = Assignments.of(
            Arrays.asList(0.2d, 0.8d, 0.1d, 0.9d, 0.4d, 0.6d, 0.3d, 0.7d, 0.9d, 0.1d, 0.2d, 0.8d), a, b, c)
                .stream()
    ...
    public void testProduct() {
        ...
        Factor factorA = Assignments.of(Arrays.asList(0.11d, 0.89d), a).stream().collect(FactorCollectors.toFactor());
        Factor factorB = Assignments.of(Arrays.asList(0.59d, 0.41d, 0.22d, 0.78d), b, a)
                .stream().collect(FactorCollectors.toFactor());
        Factor factorC = Assignments.of(Arrays.asList(0.0649d, 0.1958d, 0.0451d, 0.6942d), a, b)
                .stream().collect(FactorCollectors.toFactor());
    ...
    public void testProduct2() {
        ...
        Factor factorA = Assignments.of(Arrays.asList(0.5d, 0.8d, 0.1d, 0d, 0.3d, 0.9d), b, a).stream()
                .collect(FactorCollectors.toFactor());

        Factor factorB = Assignments.of(Arrays.asList(0.5d, 0.7d, 0.1d, 0.2d), c, b)
                .stream()
                .collect(FactorCollectors.toFactor());

        Factor factorC = Assignments.of(
    ...
    public void testProduct3() {
        ...
        Factor x = Assignments.of(Arrays.asList(0.5d, 0.8d, 0.1d, 0d, 0.3d, 0.9d), b, a)
                .stream()
                .collect(FactorCollectors.toFactor());

        Factor y = Assignments.of(Arrays.asList(0.5d, 0.7d, 0.1d, 0.2d), d, c)
                .stream()
                .collect(FactorCollectors.toFactor());

        Factor z = Assignments.of(
                Arrays.asList(0.25d, 0.05d, 0.15d, 0.08d, 0d, 0.09d, 0.35d, 0.07d, 0.21d, 0.16d, 0d, 0.18d),
                e, f, g)
                .stream()
                .collect(FactorCollectors.toFactor());

        Factor result = Assignments.of(
                Arrays.asList(
                        0.06250, 0.01250, 0.03750, 0.10000, 0.00000, 0.11250, 0.01250, 0.00250, 0.00750, 0.02000,
    ...
    public void testMarginalization() {
        ...
        Factor factorA = Assignments.of(Arrays.asList(0.59d, 0.41d, 0.22d, 0.78d), b, a).stream()
                .collect(FactorCollectors.toFactor());

        Factor factorB = Assignments.of(Arrays.asList(1d, 1d), a).stream()
                .collect(FactorCollectors.toFactor());
    ...
    public void testMarginalization2() {
        ...
        Factor x = Assignments.of(Arrays.asList(0.33d, 0.05d, 0.24d, 0.51d, 0.07d, 0.39d), a, c)
                .stream().collect(FactorCollectors.toFactor());

        Factor z = Assignments.of(Arrays.asList(0.25d, 0.35d, 0.08d, 0.16d, 0.05d, 0.07d, 0d,
                0d, 0.15d, 0.21d, 0.09d, 0.18d), c, b, a)
                .stream().collect(FactorCollectors.toFactor());
    ...
    public void testObserveEvidence() {
        ...
        Factor factorB = Assignments.of(Arrays.asList(0.59d, 0d, 0.22d, 0d), b, a).stream()
                .collect(FactorCollectors.toFactor());
