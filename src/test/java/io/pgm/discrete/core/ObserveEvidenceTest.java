...
public final class ObserveEvidenceTest {
    ...
    public void testEvidence_case2() {
        ...
        Assert.assertEquals(
            s2.collect(Collectors.toList()),
            s1.evidence(var3.set(1).and(var1.set(1)).and(var2.set(1)).toMultiAssignment())
    ...
    public void testEvidence_case3() {
        ...
        Assert.assertEquals(
                s2.collect(Collectors.toList()),
                s1.evidence(var3.set(1).and(var1.set(1)).toMultiAssignment()).collect(Collectors.toList()));
    }
}
