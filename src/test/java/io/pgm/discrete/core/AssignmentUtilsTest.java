...
public class AssignmentUtilsTest {
    ...
    public void testSubAssignmentIndexes() {
        RandomVariable<Integer, Integer> a = RandomVariable.label(1).events(1, 2, 3).build();
        RandomVariable<Integer, Integer> b = RandomVariable.label(2).events(1, 2, 3).build();
        RandomVariable<Integer, Integer> c = RandomVariable.label(3).events(1, 2, 3).build();
